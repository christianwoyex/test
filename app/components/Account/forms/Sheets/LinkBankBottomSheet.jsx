...
const LinkBankBottomSheet = forwardRef(({ handleSheetChanges, itemIndex = 1, children, ...rest }, ref) => {
	// variables
	const snapPoints = useMemo(() => ["25%", "45%", "55%"], [])
	// ref
...
export default LinkBankBottomSheet
