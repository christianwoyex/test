...
const LoanFiltercard = ({ loanType = "Small Business Term Loan", offerAmount = "0.00", interestRate = "0", frequency = "", duration = 0, repayment }) => {
	return (
		<View style={styles.container}>
			...
			<View style={styles.content}>
				...
				<View style={styles.row}>
					...
					<View style={styles.inputContainer}>
						<Text style={styles.subTextheader}>{formatThousand(`${repayment}.00`)}</Text>
					</View>
				</View>
			</View>
		</View>
