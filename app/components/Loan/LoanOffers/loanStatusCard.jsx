...
import { IconLoanStatus, IconLoanStatusBg, IconWhiteArrowForward } from "../../../../assets/icons"
import { observer } from "mobx-react"
const { width, height } = Dimensions.get("window")

const LoanStatusCard = ({ subtext = "", title = "", bgColor = "", onPress }) => {
	return (
...
export default observer(LoanStatusCard)
